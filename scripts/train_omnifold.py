...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="OmniFold training script with distributed computing."
    )
    parser.add_argument(
        "--folder",
        type=str,
    ...
    parser.add_argument(
        "--epoch", type=int, default=20, help="Maximum number of epochs"
    )
    ...
    parser.add_argument(
        ...
        type=float,
        default=5.0,
        help="Factor for slower learning rate when fine-tuning",
    )
    parser.add_argument(
