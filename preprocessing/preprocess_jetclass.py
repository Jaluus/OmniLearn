...
if __name__ == "__main__":
    ...
    parser.add_option(
        "--sample", type="string", default="train", help="Input file name"
    )
    parser.add_option(
        "--folder",
        type="string",
        default="/pscratch/sd/v/vmikuni/PET/JetClass",
        help="Folder containing downloaded files",
    )
...
if flags.sample == "train":
    process_and_save(
        os.path.join(flags.folder, "train_100M"), n_splits=1000, name="train"
    )
